...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    bench_case(c, &rt, "many categories, few rows", 100_000, 100);
    bench_case(c, &rt, "many categories, few rows", 100_000, 50);
    bench_case(c, &rt, "many categories, few rows", 100_000, 10);
    bench_case(c, &rt, "many categories, few rows", 100_000, 1);
}
