...
impl LimitConfig {
    /// Create a new LimitConfig with a limit and no specific ordering
    ...
    /// Create a new LimitConfig with a limit and ordering direction
...
pub struct AggregateExec {
    ...
    /// Configuration for limit-based optimizations (TopK aggregation)
    limit_config: Option<LimitConfig>,
...
impl AggregateExec {
    ...
    pub fn with_limit_config(mut self, limit_config: Option<LimitConfig>) -> Self {
        self.limit_config = limit_config;
        self
    }

    /// Get the ordering direction for the limit (if set)
    pub fn limit_config(&self) -> Option<LimitConfig> {
        self.limit_config
    }
    ...
    fn execute_typed(
        ...
        if let Some(config) = self.limit_config
...
impl ExecutionPlan for AggregateExec {
    ...
    fn with_new_children(
        ...
        me.limit_config = self.limit_config;
